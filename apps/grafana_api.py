...
import cdsw
model_deployment_crn = "crn:cdp:ml:us-west-1:9d74eee4-1cad-45d7-b645-7ccf9edbb73d:workspace:c4b02aca-fcae-4440-9acc-c38c2d6a7d2c/937d797a-034d-4c54-90a4-ed8e0c2512fe"
...
if __name__ == '__main__':
    ...
    add_reader('predictions', get_predictions)

    # To query the wanted reader, use `<reader_name>:<query_string>`, e.g. 'sine_wave:24' 

    app.run(host='0.0.0.0', port=os.environ["CDSW_PUBLIC_PORT"], debug=True)